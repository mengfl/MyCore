...
public final class SnackBarUtils {
    ...
    public static void showSnackBar(AppCompatActivity activity, String text) {
    ...
    public static void showSnackBar(AppCompatActivity activity, String text, String action, View.OnClickListener listener) {
    ...
    public static void showSnackBar(AppCompatActivity activity, String text, String action, @DrawableRes int resId, View.OnClickListener listener) {
